...
UPDATE `frontends` SET `tempname` = 'global' WHERE `frontends`.`id` = 1;

-- ??FAQs for campaigns??
ALTER TABLE `campaigns` ADD `faqs` TEXT NULL DEFAULT NULL AFTER `proof_images`;
ALTER TABLE `campaigns` ADD `donor_visibility` TINYINT(1) NOT NULL DEFAULT '1' COMMENT 'Yes=>1, No->0' AFTER `extend_goal`;
ALTER TABLE `campaigns` ADD `seo_content` TEXT NULL DEFAULT NULL AFTER `donor_visibility`;
...
-- campaigns--
ALTER TABLE `campaigns` ADD `goal_type` TINYINT(1) NULL DEFAULT '0' COMMENT '1-> After Goal,\r\n2->After Deadline,\r\n3->Continuous Campaign' AFTER `goal`;
...
-- users __
ALTER TABLE `users` ADD `cover` VARCHAR(40) NULL DEFAULT NULL AFTER `image`;
ALTER TABLE `users` ADD `description` TEXT NULL DEFAULT NULL AFTER `cover`;
ALTER TABLE `users` ADD `enable_org` TINYINT(1) NOT NULL DEFAULT '0' AFTER `cover`;
ALTER TABLE `users` DROP `ref_by`;

-- General_settings__
ALTER TABLE `general_settings` ADD `system_customized` TINYINT(1) NOT NULL DEFAULT '0' AFTER `system_info`;
ALTER TABLE `general_settings` ADD `raised_charge` DECIMAL(5,2) NOT NULL DEFAULT '0' COMMENT 'Charged for Raised amount in withdraw' AFTER `anonymous_donation`;
...
CREATE TABLE `organizations` (
  ...
  `image` varchar(40) DEFAULT NULL COMMENT 'ProfileImage for org!',
  `cover` varchar(40) DEFAULT NULL,
  `address` text DEFAULT NULL COMMENT 'email, mobile, address ',
...
CREATE TABLE `organization_donors` (
  `id` bigint(20) NOT NULL,
  `organization_id` int(10) NOT NULL DEFAULT 0,
  `name` varchar(40) DEFAULT NULL COMMENT 'Donor name',
  `image` varchar(40) DEFAULT NULL COMMENT 'Donor image',
  `details` varchar(255) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

ALTER TABLE `organization_donors`
  ADD PRIMARY KEY (`id`);
...
-- comments ----
ALTER TABLE `comments` ADD `user_id` INT(10) NOT NULL DEFAULT '0' AFTER `id`;
ALTER TABLE `comments` DROP `fullname`;
ALTER TABLE `comments` DROP `email`;
ALTER TABLE `comments` CHANGE `comment` `review` TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;
...
ALTER TABLE `general_settings` ADD `available_version` VARCHAR(40) NULL DEFAULT NULL AFTER `currency_format`;
...
INSERT INTO `frontends` (`id`, `data_keys`, `data_values`, `tempname`, `created_at`, `updated_at`)
VALUES (NULL, 'faq.content', 
'{\"title\":\"The following is a set of FAQs on Regulation Crowdfunding for the guidance of FINRA members. For additional information, visit our Funding Portal webpage.\"}', 
'basic', NULL, NULL);
...
UPDATE campaigns SET goal_type = 2 WHERE deadline IS NOT NULL;
