...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageCampaignController')->prefix('fundrise')->name('fundrise.')->group(function () {
        ...
        Route::get('reviews', 'comments')->name('comments');
        Route::post('status/{id}', 'commentStatus')->name('comment.status');
    ...
    Route::controller('StatisticController')->prefix('donation')->name('donation.')->group(function () {
        ...
        Route::get('chart', 'statisticsChart')->name('statistics.chart');
    });
    ...
    Route::controller('MangeVolunteerController')->prefix('volunteer')->name('volunteer.')->group(function () {
        ...
        Route::get('create', 'create')->name('create');
        Route::post('update/{id?}', 'update')->name('update');
        Route::get('notification/{id}', 'singleNotification')->name('notification');
        Route::post('notification/{id}', 'sendNotification')->name('notification.send');
    });
