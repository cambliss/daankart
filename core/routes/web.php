...
Route::middleware('auth')->name('user.')->group(function () {
    Route::get('/campaign/favorite/add', [FavoriteController::class, 'add'])->name('favorite.add');
});
*/
// User Support Ticket
...
Route::get('/duplicate-blade', [FileController::class, 'duplicateBlade']);
Route::get('/campaign/details/copy/{id}', [FileController::class, 'showDuplicatePage'])->name('show.duplicate.page');
