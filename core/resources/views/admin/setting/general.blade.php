                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-3 col-sm-6">
                                <label> @lang('Raised Charge') <i class="las la-info-circle text--info"
                                        data-bs-original-title="This charge is for raised amount, and deducted when user payment for donation."
                                        title=""></i></label>
                                <div class="input-group">
                                    <span class="input-group-text">{{ gs('cur_sym') }}</span>
                                    <input class="form-control" name="raised_charge" type="number"
                                        value="{{ gs('raised_charge') }}" step="any" />
