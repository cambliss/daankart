...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $campaign['total_campaign'] }}" title="Total Campaign" style="7"
                link="{{ route('admin.fundrise.index') }}" icon="las la-network-wired" bg="success" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $campaign['total_pending'] }}" title="Pending Campaign" style="7"
                link="{{ route('admin.fundrise.pending') }}" icon="fas fa-spinner" bg="warning" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $campaign['total_running'] }}" title="Running Campaign" style="7"
                link="{{ route('admin.fundrise.running') }}" icon="fas fa-coins" bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget value="{{ $campaign['total_comments'] }}" title="Campaign Reviews" style="7"
                link="{{ route('admin.fundrise.comments') }}" icon="fas fa-comment-dollar" bg="danger" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-wrap justify-content-between">
                        ...
                        <div class="border p-1 cursor-pointer rounded" id="trxDatePicker">
                            <i class="la la-calendar"></i>&nbsp;
                            <span></span> <i class="la la-caret-down"></i>
                        </div>
                    </div>
