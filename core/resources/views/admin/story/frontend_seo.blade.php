...
@section('panel')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.success.story.update.seo', $data->id) }}" class="disableSubmission" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    <label>@lang('SEO Image')</label>
                                    <x-image-uploader class="w-100" :imagePath="frontendImage('success_story',@$data->seo_content->image,getFileSize('seo'),true)" :size="getFileSize('seo')" :required="false" />
                                </div>
                            </div>
...
@push('breadcrumb-plugins')
        <x-back route="{{ route('admin.success.story.detail', $data->id) }}" />
@endpush
