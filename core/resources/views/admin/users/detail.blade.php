    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.fundrise.index') }}?search={{ $user->username }}"
                        title="Total Campaigns" icon="las la-network-wired" value="{{ $widget['total_campaign'] }}"
                        bg="success" type="2" />
                </div>


                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.fundrise.running') }}?search={{ $user->username }}"
                        title="Running Campaigns" icon="las la-biohazard" value="{{ $widget['running_campaign'] }}"
                        bg="primary" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.fundrise.pending') }}?search={{ $user->username }}"
                        title="Pending Campaigns" icon="la la-spinner" value="{{ $widget['pending_campaign'] }}"
                        bg="warning" type="2" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.fundrise.rejected') }}?search={{ $user->username }}"
                        title="Rejected Campaigns" icon="las la-ban" value="{{ $widget['rejected_campaign'] }} "
                        bg="danger" type="2" />
                </div>
