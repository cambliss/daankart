    ...
    <div class="my-5">
        <div class="container ">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <form class="deposit-form" action="{{ route('deposit.insert') }}" method="post">
                        @csrf
                                ...
                                <div class="row justify-content-center gy-sm-4 gy-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="payment-system-list p-3">
                                            <div class="deposit-info">
                                                ...
                                                <div class="deposit-info__input">
                                                    <div class="deposit-info__input-group input-group">
                                                        <span
                                                            class="deposit-info__input-group-text px-3">{{ gs('cur_sym') }}</span>
                                                        <input class="form-control form--control amount" name="amount"
                                                            type="text" value="{{ old('amount', @$donation->donation) }}"
                                                            step="any" placeholder="@lang('00.00')" readonly
                                                            autocomplete="off">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <button class="btn cmn-btn w-100 mt-3" type="submit" disabled>
