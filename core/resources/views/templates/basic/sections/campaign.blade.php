...
<section class="campaign-section pt-120 pb-120 position-relative base--bg">
    <div class="section-img">
        <!--<img src="{{ getImage($activeTemplateTrue . 'images/texture-3.jpg') }}" alt="section-img">-->
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-8">
                <div class="section-header text-center">
                    <h2 class="section-title text-black">{{ __(@$campaignContent->data_values->title) }}</h2>
                    <p class="text-black">{{ __(@$campaignContent->data_values->description) }}</p>
                </div>
            </div>
        </div><!-- row end -->
