    ...
    function pushNotifyAction() {
        ...
        if (!('Notification' in window)) {
            ...
            $('.notice').append(`
                ...
                <div class="alert border border-danger notification-alert" role="alert">
                            <div class="alert__icon d-flex align-items-center text-danger"><i class="las la-info-circle"></i> </div>
                            <p class="alert__message notice_notify">
