...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $widget['total_campaign']     = Campaign::where('user_id', $id)->count();
        $widget['running_campaign']   = Campaign::running()->boundary()->where('user_id', $id)->count();
        $widget['pending_campaign']   = Campaign::pending()->where('user_id', $id)->count();
        $widget['rejected_campaign']  = Campaign::rejected()->where('user_id', $id)->count();
