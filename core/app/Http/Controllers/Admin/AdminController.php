...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $campaign['total_campaign'] = Campaign::count();
        $campaign['total_pending']  = Campaign::pending()->count();
        $campaign['total_running']  = Campaign::active()->running()->inComplete()->count();
        $campaign['total_comments'] = Comment::whereHas('campaign')->count();

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart','deposit','withdrawals', 'campaign'));
    }
