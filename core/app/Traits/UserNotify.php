...
trait UserNotify
{
    public static function notifyToUser(){
        return [
            ...
            'notCampaignUsers'                    => 'User Has No Campaign',
            'hasCampaignUsers'                    => 'User Has Campaigns',
            'hasAtLeastOneCampaignRunningUsers'   => 'User Has At least One or Multiple Campaigns Running',
            'hasAtLeastOneCampaignCompletedUsers' => 'User Has At least One or Multiple Campaigns Completed',
        ];
    }

    public function scopeNotCampaignUsers($query)
    {
        return $query->whereDoesntHave('campaigns');
    }
    public function scopeHasCampaignUsers($query)
    {
        return $query->whereHas('campaigns');
    }
    public function scopeHasAtLeastOneCampaignRunningUsers($query)
    {
        return $query->whereHas('campaigns', function($subQ){$subQ->running()->boundary();});
    }
    public function scopeHasAtLeastOneCampaignCompletedUsers($query)
    {
        return $query->whereHas('campaigns', function($subQ){$subQ->completed();});
    }
