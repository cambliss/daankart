...
function mainSlider() {
	...
	BasicSlider.on('init', function (e, slick) {
		var $firstAnimatingElements = $('.single__slide:last-child').find('[data-animation]');
...
$('#confirmationModal').on('show.bs.modal', function (e) {
	$(this).find('.modal-footer .btn--primary').removeClass('btn--primary').addClass('cmn-btn btn-sm');
});
